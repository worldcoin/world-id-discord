...
const steps = [
  ...
  },
  {
    ...
    content: (
      <span>
        Verify you are a human with an Orb Operator to activate <br /> your World ID. You’ll also get access to free
        airdrops!
      </span>
    ),
  },
      ...
      <div className="grid gap-y-16 md:gap-y-24 col-start-2">
        ...
        <div className="grid md:grid-flow-col md:auto-cols-min justify-self-center gap-6">
          <Link
            ...
            variant="flat"
          >
            <Icon className="h-7 w-full" noMask name="app-store" />
          </Link>
          ...
          <Link
            ...
            variant="flat"
          >
            <Icon className="h-7 w-full" noMask name="play-market" />
          </Link>
        </div>
      </div>
    </div>
